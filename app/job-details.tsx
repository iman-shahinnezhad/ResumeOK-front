  ...
  const handleStartAiTailoring = async () => {
    ...
    try {
      ...
      const candidateName = (userProfile?.firstName && userProfile?.lastName)
        ...
        : userProfile?.firstName || 'Candidate Name';
      ...
      const candidateSummary = userProfile?.summary || userProfile?.about || `Results-driven professional targeting the ${jobTitle} position at ${companyName}. Proven expertise in project execution, team collaboration, and workflow optimization.`;
